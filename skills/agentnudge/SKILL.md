---
name: agentnudge
description: Run AgentNudge website feedback with manual, Codex, or Claude ACP chat. Use when embedding the widget, waiting, replying, reading transcripts, or controlling the preview.
---
...
- Read [references/embedded-agent.md](references/embedded-agent.md) before starting Codex or Claude ACP, supplying starter context, querying a transcript, or relying on page-driven session close.
